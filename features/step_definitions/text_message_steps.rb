...
Then /^#{relative_reference} #{capture_model} destined for #{capture_model} should (not )?be #{capture_model}$/ do |text_message_index, name, mobile_number, expectation, text_message|
